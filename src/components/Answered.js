...
class Answered extends Component {
    render() {
        const { question, author, authUsers } = this.props;
                    ...
                    <Card bg="light" className="m-3">
                        ...
                        <Card.Body className="d-flex justify-content-center">
                            <ul>
                                <li>
                                    {optionOne.text}
                                    {optionOne.votes.includes(authUsers) ? (
                                ...
                                <li>
                                    {optionTwo.text}
                                    {optionTwo.votes.includes(authUsers) ? (
                                        <span className="text-danger ml-2">
                                            &lt;- Your choice
                                        </span>
                                    ) : null}
...
function mapStateToProps({ questions, users, authUsers }, { id }) {
